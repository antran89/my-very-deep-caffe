...
#include "caffe/layers/twostream_snippet_data_layer.hpp"
#include "caffe/util/benchmark.hpp"

namespace caffe {

template <typename Dtype>
TwostreamSnippetDataLayer<Dtype>::TwostreamSnippetDataLayer(const LayerParameter& param)
    : BasePrefetchingTwostreamDataLayer<Dtype>(param),
      reader_(param), num_test_views_(1) {
}

template <typename Dtype>
TwostreamSnippetDataLayer<Dtype>::~TwostreamSnippetDataLayer() {
    this->StopInternalThread();
}

template <typename Dtype>
void TwostreamSnippetDataLayer<Dtype>::DataLayerSetUp(const vector<Blob<Dtype>*>& bottom,
...
template<typename Dtype>
void TwostreamSnippetDataLayer<Dtype>::load_batch(TwostreamBatch<Dtype>* batch) {
...
INSTANTIATE_CLASS(TwostreamSnippetDataLayer);
REGISTER_LAYER_CLASS(TwostreamSnippetData);
