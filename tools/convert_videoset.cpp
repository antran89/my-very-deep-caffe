...
int main(int argc, char** argv) {
  ...
  std::string filename;
  int video_length, label;
  while (infile >> filename >> video_length >> label) {
    lines.push_back(std::make_pair(filename, std::make_pair(video_length, label)));
  }
  if (FLAGS_shuffle) {
